...
const TABLE_HEAD = [
  { id: '', label: '순번', alignRight: false },
  { id: 'company', label: '강의명', alignRight: false },
  { id: 'role', label: '강의상태', alignRight: false },
  { id: 'isVerified', label: '경매시작일자', alignRight: false },
  { id: 'status', label: '경매종료일자', alignRight: false },
  { id: '' },
];
                  ...
                  {info.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">{lectStatus}</TableCell>
